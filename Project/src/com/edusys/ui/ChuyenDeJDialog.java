...
public class ChuyenDeJDialog extends javax.swing.JDialog {
    ...
    public boolean check() {
        ...
        if (txtMaCD.getText().equals("")) {
            ...
            return false;
        } else if (Integer.parseInt(txtThoiLuong.getText()) < 0 || Integer.parseInt(txtThoiLuong.getText()) == 0) {
            MsgBox.alert(this, "Nhập thời lượng lớn hơn 0");
            return false;
        } else if (txtHocPhi.getText().equals("") ) {
            MsgBox.alert(this, "Chưa nhập học phí");
            return false;
        } else if (txtMota.getText().equals("")) {
            MsgBox.alert(this, "Chưa nhập mô tả");
            return false;
        } else if (Double.parseDouble(txtHocPhi.getText()) < 0 || Double.parseDouble(txtHocPhi.getText()) == 0) {
            MsgBox.alert(this, "Nhập học phí lớn hơn 0");
            return false;
        }else if (txtHocPhi.getText().equals(checknumber)){
            MsgBox.alert(this,"Không được nhập chữ");
            return false;
        } else if (txtThoiLuong.getText().equals(checknumber)){
            MsgBox.alert(this,"Không được nhập chữ");
            return false;
        }
        return true;
